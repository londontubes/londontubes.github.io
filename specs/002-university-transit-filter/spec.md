...
- **Map implementation uses Leaflet/OpenStreetMap** instead of Google Maps for cost-free, open-source mapping with react-leaflet integration, TileLayer, CircleMarker, Circle, Polyline, and Popup components.
