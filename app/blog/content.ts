...
export const blogQuestions: BlogQuestion[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'When you click on a promising purple station, the station card includes a “Zoopla rental search” button and, for mapped stations, a matching “Rightmove rental search” button. These open rental searches centred on that station, already filtered for smaller flats within a sensible budget and walking radius so you can jump straight from journey times to real listings.',
  ...
  },
  {
    ...
    shortAnswer:
      'Open the Universities Filter, pick your campus, then use the green walking time and purple tube time sliders to find good areas and jump straight into Zoopla and Rightmove rental searches from promising stations.',
    body: [
      ...
      'Once you see clusters of green and purple stations you like the look of, click on one of the purple stations. In the station card, use the “Zoopla rental search” and “Rightmove rental search” buttons to open pre-filtered rental searches centred on that station.',
